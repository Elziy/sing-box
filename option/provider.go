...
type ProviderLocalOptions struct {
	...
	Override    *OverrideOptions   `json:"override,omitempty"`
}
...
func (o *OutboundProviderOptions) UnmarshalJSONContext(ctx context.Context, inputContent []byte) error {
	...
	return json.UnmarshalContext(ctx, inputContent, (*_OutboundProviderOptions)(o))
}
