...
func BaseContext(platformInterface PlatformInterface) context.Context {
	...
	return box.Context(context.Background(), include.InboundRegistry(), include.OutboundRegistry(), include.ProviderRegistry(), include.EndpointRegistry(), dnsRegistry, include.ServiceRegistry())
}
